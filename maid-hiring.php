...
<div style="text-align: right; padding: 20px;">
  <a href="package.php" style="font-size: 28px; font-weight: bold; text-decoration: none; color: red;">&times;</a>
</div>
    ...
    <section class="contact-section">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="text" name="contno" value="" class="form-control" required maxlength="10" pattern="[0-9]+">
              </div>
            </div>
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label style="color: red; font-weight: bold; font-size: 20px;">Gender:</label> <br>
            ...
            <div class="col-sm-12">
              <div class="form-group">
                <label style="color: red; font-weight: bold; font-size: 20px;">Select Service:</label>
                <br>
                <?php
                  $selectedCat = isset($_GET['catid']) ? $_GET['catid'] : '';
                ?>
                <select name="catid" class="form-control" required>
                  ...
                  foreach ($result2 as $row2) {
                      $isSelected = ($selectedCat == $row2->ID) ? 'selected' : '';
                      echo "<option value='" . htmlentities($row2->ID) . "' $isSelected>" . htmlentities($row2->CategoryName) . "</option>";
                  }
                  ?>
                </select>
              </div>
