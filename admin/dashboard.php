...
<div class="col-md-6 col-lg-3">
   <div class="full counter_section margin_bottom_30">
      <div class="couter_icon">
         <div> 
            <i class="fa fa-comments green_color"></i> <!-- Feedback icon -->
         </div>
      </div>
      <div class="counter_no">
         <div>
            <?php 
            // Use PDO just like other counters
            $sql5 ="SELECT * FROM feedbacks";
            $query5 = $dbh->prepare($sql5);
            $query5->execute();
            $results5 = $query5->fetchAll(PDO::FETCH_OBJ);
            $totfeedback = $query5->rowCount();
            ?>
            
            <p class="total_no"><?php echo htmlentities($totfeedback); ?></p>
            <p class="head_couter">
               Total Feedbacks<br /><br /><br />
               <a href="feedback.php" class="btn btn-primary btn-sm">View Details</a>
            </p>
         </div>
      </div>
   </div>
